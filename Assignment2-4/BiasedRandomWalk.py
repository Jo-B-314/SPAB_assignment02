...
def Randomwalk1D(n): #n here is the no. of steps that we require
   ...
   for i in range (1,n+1):
       ...
       if step < threshold: # if step is less than 0.5 we move up    
           x += 1
           y += 1  #moving up in u direction
       if step > threshold: # if step is greater than 0.5 we move down  
           x += 1
...
## Trigger counts how many of the Walks get below zero.
